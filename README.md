...
Training data is on [GoogleDrive](https://drive.google.com/file/d/1tXQ8qB2bS7JZz4wKmEzu0Qb0apPjOAr-/view?usp=sharing)  [BaiduPan](https://pan.baidu.com/s/1lubZFMQCum0iIr2RpBloOA),  the code is ***tis2***. There are *585* stereo pairs for the training dataset (1.8 Go). The folder structure is introduced above.
